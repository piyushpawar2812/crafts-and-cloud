...
// Portfolio data for carousel
        ...
        const portfolioData = [
            ...
            },
         {
            ...
            description: "Modern web development platform delivering fast, responsive, and scalable digital experiences.",
            ...
            tech: ["HTML5", "CSS3", "JavaScript", "React"]
                ...
                description: 'Our solutions include multi-factor authentication, single sign-on, biometric verification, and secure session management.',
                image: 'images/authentication.png',
                tech: ['OAuth 2.0', 'JWT', 'Firebase Authentication']
            },
            
            {
                id: 4,
                title: 'Cyber Defense',
                description: 'We provide comprehensive cyber security services designed to protect your business from modern digital threats. Our solutions include network security, data protection, vulnerability assessments, cloud security, and continuous monitoring.',
        ...
        const skillsData = [
            ...
            { name: 'HTML', icon: '📘', level: 88, category: 'frontend' },
            { name: 'CSS', icon: '💚', level: 88, category: 'frontend' },
            { name: 'Java Script', icon: '☸️', level: 88, category: 'frontend' },
       ...
       // Smooth scrolling + Active nav (CLEAN VERSION)
